...
from guin_e_turtle.msg import TopicInfo, Log
from guin_e_turtle.srv import RequestParamRequest, RequestParamResponse
    ...
    def listen(self):
        ...
        while True:
            ...
            if self.fork_server: # if configured to launch server in a separate process
                ...
                break	# Added line of code that made all the difference needed for GuiN-E Bot
