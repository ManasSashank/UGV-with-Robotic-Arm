...
import rospy
from guin_e_turtle import SerialClient, RosSerialServer
...
if __name__=="__main__":
    rospy.init_node("rosserial_python_node")
    ...
    if port_name == "tcp" :
        ...
        try:
            server.listen() # Modified here : Check RosSerialServer for Modification 
